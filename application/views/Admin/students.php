...
<!--  ACTIVE NOT WORK -->
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <hr>
                    <div id="showme1" class="alert-success" alert-dismissible style="display:none;">Students Added sucessfully</div>
                    <div class="col-md-6" text-right>
                        <!-- Corrected function name from 'showmodel' to 'showModel' -->
                        <a href="javascript:void(0)" onclick="showModel();" class="btn btn-warning">ADD Students</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-body">
        <div class="form-group">
            <label for="course_name">Enter Student name</label>
        ...
        <div class="form-group">
            <label for="course_fees">Class</label>
            <input type="text" name="class" id="class" class="form-control" >
            <p class="namError"></p>
        </div>
        <div class="form-group">
            <label for="course_started">Date of Birth</label>
