...
<!--  ACTIVE NOT WORK -->
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <div class="col-6">
                        <h3>Category (<?php echo sizeof($user); ?>)</h3>
                    </div>
                    <hr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <?php if($use['status']==1){?>
                        <a class="btn btn-info"  href="<?php echo base_url('admin/status/'.$use['id']);?>" >Active</a>
                        <?php }
                        else{?>
                 <a class="btn btn-danger"  href="<?php echo base_url('admin/destatus/'.$use['id']);?>" >Deactive</a>
                 <?php }?>
...
// form submittion in Ajax
 ...
 $.ajax({
     url: "<?php echo base_url('admin/addcategorys');?> ",
